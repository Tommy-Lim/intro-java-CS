...
// Import Statements 
//
// Do not modify these imports; they are needed by the methods that
// you are being given
...
public class ManipulateImage {
    ...
    public static void printImageInfo(BufferedImage buff, String imageFilename) {
    	System.out.println(imageFilename+" height is "+buff.getHeight()+" pixels.");
    	System.out.println(imageFilename+" width is "+buff.getWidth()+" pixels.");
    	System.out.println(imageFilename+" type is "+buff.getType()+".");
    }
